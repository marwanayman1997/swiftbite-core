...
| GET    | `/product/restaurants/:restaurantId/categories`            | Public                             |
| GET    | `/product/branches/:branchId/products`                     | Public                             |
| GET    | `/product/products/:id`                                    | Public                             |
| GET    | `/product/restaurants/:restaurantId/products`               | RBAC (`core:product:read`)         |
...
| GET    | `/restaurants/:restaurantId/members`                       | RBAC (`core:member:read`)          |
