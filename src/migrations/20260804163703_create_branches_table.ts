...
export async function up(knex: Knex): Promise<void> {
  await knex.raw(`
        ...
        CREATE INDEX idx_restaurant_branch_restaurant_id ON restaurant_branches(restaurant_id);
        CREATE INDEX idx_restaurant_branch_is_active ON restaurant_branches(is_active);
        CREATE INDEX idx_restaurant_branch_location ON restaurant_branches USING GIST(location);
